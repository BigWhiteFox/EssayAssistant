...
def fox_chat_chat(api_key, secret_key, key, message, image_path=None, temperature=0.2, top_p=0.8, max_tokens=1024):
    ...
    if image_path is None:
        url = ("https://aip.baidubce.com/rpc/2.0/ai_custom/v1/wenxinworkshop/chat/completions_pro?access_token="
               + get_access_token(api_key=api_key, secret_key=secret_key))
        ...
        payload = json.dumps({
            ...
            "top_p": top_p,
            "penalty_score": 1,
            "system": "你将扮演一位心理疗愈师，通过幽默风趣的对话帮助疲惫的学生缓解压力。",
...
# fox_chat_chat("bbbd0deb2e83869a810a3aa32d866b36.z8W6AkgbgewipUae", "你好")
